...
TOOLS = [
    ...
    Tool(
        ...
        description="[Deprecated: use get_changed_symbols with ref param instead] Return a compact symbol-oriented summary of git changes since a given ref.",
        inputSchema={
            "type": "object",
            "properties": {
                "since_ref": {
    ...
    Tool(
        ...
        description="[Deprecated: use apply_symbol_change_and_validate with rollback_on_failure=true] Replace, validate, rollback on failure.",
        inputSchema={
            "type": "object",
            "properties": {
                "symbol_name": {
...
def _h_get_changed_symbols_since_ref(slot, args):
    ...
    return _h_get_changed_symbols(slot, args)
...
def _h_apply_symbol_change_validate_with_rollback(slot, args):
    ...
    return _h_apply_symbol_change_and_validate(slot, args_copy)
